...
class TestGuiInternalState(unittest.TestCase):
    def setUp(self):
        ...
        with patch.object(PySCFDialog, 'setup_ui', return_value=None), patch.object(PySCFDialog, 'load_settings', return_value=None):
    ...
    def test_apply_defaults(self):
        ...
        self.dialog.calc_tab.job_type_combo.setCurrentText.assert_called_with("Optimization + Frequency")
